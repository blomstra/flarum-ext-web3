...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('blomstra/web3', function () {
  ...
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('blomstra-web3').registerSetting({
    ...
    type: 'text',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('blomstra-web3.admin.settings.infura-project-id'),
    help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('blomstra-web3.admin.settings.infura-project-id-help')
  });
});
